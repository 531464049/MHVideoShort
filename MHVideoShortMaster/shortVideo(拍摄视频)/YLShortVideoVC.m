...
-(void)setupView
{
    ...
    [self.goBackBtn setImage:[UIImage imageNamed:@"shortback"] forState:0];
    [self.goBackBtn addTarget:self action:@selector(goBack) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:self.goBackBtn];
    self.goBackBtn.sd_layout.centerXIs(Screen_WIDTH/2-Width(90)-Width(25)).centerYEqualToView(self.takeButton).widthIs(Width(50)).heightEqualToWidth();
    
    //切换摄像头按钮
    self.changeSXTBtn = [UIButton buttonWithType:0];//48*40
    [self.changeSXTBtn setImage:[UIImage imageNamed:@"切换摄像头"] forState:0];
    ...
    self.changeSXTBtn.sd_layout.rightSpaceToView(self.view, 20).widthIs(48).heightIs(40).topSpaceToView(self.view, 30);
    
    //相册选择按钮
    self.chooseLib = [UIButton buttonWithType:0];
    [self.chooseLib setImage:[UIImage imageNamed:@"shipinliebiao@2x"] forState:0];
    ...
    self.chooseLib.sd_layout.centerXIs(Screen_WIDTH/2 + Width(90)+Width(25)).centerYEqualToView(self.takeButton).widthIs(Width(50)).heightEqualToWidth();
...
- (void)setupTimer
{
    ...
    self.goBackBtn.sd_resetLayout.centerXIs(Screen_WIDTH/2-Width(90)-Width(25)).centerYEqualToView(self.takeButton).widthIs(Width(50)).heightEqualToWidth();
    self.chooseLib.sd_resetLayout.centerXIs(Screen_WIDTH/2 + Width(90)+Width(25)).centerYEqualToView(self.takeButton).widthIs(Width(50)).heightEqualToWidth();
